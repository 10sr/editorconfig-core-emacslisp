...
check: build check-ert tests/CMakeLists.txt lib/editorconfig-fnmatch.el
	...
	cd ${project_root}/tests && EMACS=${emacs} EDITORCONFIG_CORE_LIBRARY_PATH="${project_root}:${project_root}/lib" ctest -V .

check-ert: $(tests_ert_el) lib/editorconfig-fnmatch.el build
